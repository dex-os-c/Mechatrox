      ...
      <div className="wrap grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-10 md:gap-16 items-start">
        <div className="reveal">
          ...
          <p style={{ fontSize: 'clamp(20px,2.6vw,28px)', lineHeight: 1.45 }}>
            ...
            {eventInfo.college} ({eventInfo.collegeShort}), {eventInfo.festName} brings ten events under one roof —
        ...
        <div className="datasheet reveal">
          ...
          <div className="row"><span className="k">FORMAT</span><span className="v">2 tracks · 10 events</span></div>
