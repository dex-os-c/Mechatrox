      ...
      <div className="wrap grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-10 md:gap-16 items-start">
        <div className="reveal">
          ...
          <p style={{ fontSize: 'clamp(20px,2.6vw,28px)', lineHeight: 1.45 }}>
            ...
            {eventInfo.college} ({eventInfo.collegeShort}), {eventInfo.festName} brings nine events under one roof —
            five for people who want to design, present, and debug real hardware, and five for people who just want
            to compete, bid, and argue about their fantasy XI.
          </p>
        </div>
        <div className="datasheet reveal">
          <div className="head">EVENT SPEC</div>
          <div className="row"><span className="k">FORMAT</span><span className="v">2 tracks · 9 events</span></div>
